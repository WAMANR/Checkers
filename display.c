...
int message=-1;///< blablabla
int victoire = 0;///< blablabla

float squaresize = 0.18;///< blablabla
float xborder = 0.1;///< blablabla
float yborder = 0.1;///< blablabla
...
int time1;///< blablabla
float speed = 1.0f;///< blablabla
int blink = 100000;///< blablabla

int choosingpiece = 1;///< blablabla
int graby,grabx,placey,placex;///< blablabla

float move_unit = 0.18f;///< blablabla

int menu=1;///< blablabla
int hints=-1;///< blablabla
int selected=-1;///< blablabla

int selectedx;///< blablabla
int selectedy;///< blablabla
